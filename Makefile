...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Wed Jul 30 11:39:02 2014
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/home/nlevy/Documents/liveview2/liveview2/../../cuda_take/ -lcuda_take -lboost_thread -lcudart -lgomp -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/liveview21.0.0/ && $(COPY_FILE) --parents mainwindow.h frameview_widget.h controlsbox.h frame_worker.h image_type.h qcustomplot.h histogram_widget.h mean_profile_widget.h fft_widget.h frame_c_meta.h view_widget_interface.h BACKEND_HEADERS .tmp/liveview21.0.0/ && $(COPY_FILE) --parents images.qrc .tmp/liveview21.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp frameview_widget.cpp controlsbox.cpp frame_worker.cpp qcustomplot.cpp histogram_widget.cpp mean_profile_widget.cpp fft_widget.cpp .tmp/liveview21.0.0/ && (cd `dirname .tmp/liveview21.0.0` && $(TAR) liveview21.0.0.tar liveview21.0.0 && $(COMPRESS) liveview21.0.0.tar) && $(MOVE) `dirname .tmp/liveview21.0.0`/liveview21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/liveview21.0.0
