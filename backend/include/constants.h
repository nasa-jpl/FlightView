...
const static unsigned int MAX_WIDTH = 3072;
const static unsigned int MAX_HEIGHT = 513;
...
static const unsigned int CPU_FRAME_BUFFER_SIZE = 500; // The frame ring buffer size in number of frame_c structs
