...
#define PDV_CL_CFG_IGNDVAL      0x2  /* alias -- matches HW doc */
#define PDV_CL_CFG_LINESCAN     0x4  /* ties FV to LV */
#define PDV_CL_CFG_ROIDIS       0x8  /* disable region of interest */
...
#define PDV_CL_CFG2_PCLVFREE     0x08   /* used to be (before lasdt rev 8) top bit of UTILITY reg but moved */
                                        /* here after that got takene by JG for IRIGB */
